  ...
  return (
    <a
      ...
      className={classNames(
        'transition-colors text-tortora-200 hover:text-tortora-500',
    ...
    <>
      ...
      >
        <div className='transition-all text-black container mx-auto px-4 sm:px-12 2xl:px-0 max-w-7xl flex flex-wrap items-center justify-end h-full'>
          <div className='hidden md:flex gap-5 uppercase tracking-widest text-xs'>
            <a
              className='text-tortora-900 hover:text-tortora-600 transition-colors'
              href='/menu.pdf'
              target='_blank'
            >
              menu
            ...
            <a
              className='text-tortora-900 hover:text-tortora-600 transition-colors'
              href='https://www.beachnow.it/?structure=nausica-beach'
              target='_blank'
            >
              spiaggia
            </a>
          ...
          <button
            ...
            type='button'
            className='z-10 inline-flex items-center p-2 ml-3 text-sm text-tortora-200 rounded-lg hover:bg-tortora-400 focus:outline-none focus:ring-2 focus:ring-tortora-900'
      ...
      <nav ref={ref}>
        <div
          className={classNames(
            'fixed top-0 h-full p-4 flex z-50 bg-tortora-900 w-1/2 flex-col gap-10 items-center overflow-hidden transition-all',
            {
